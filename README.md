...
* 4 мая занятий не будет
* Контрольная (для тех, кто не смог написать по уважительной причине) состоится 11 мая после семинара. Всем заинтересованным было разослано письмо об этом. Если вам не пришло письмо --- напишите нам.
...
* [Байесовская статистика](slides/l_13_bayes.pdf)
