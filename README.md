...
## Получение зачета 
TL;DR --- заполняете форму (будет), записываетесь на удобное вам время в таблицу (будет). Если текущая оценка --- хор или выше, по желанию получаете автомат.

Алгоритм:
1. Заполнить форму (будет)
2. Посмотреть свою [оценку]((https://docs.google.com/spreadsheets/d/1oKTGL15X1BGjQp2dIMvYn087HjI0ylyeo0HcF_MHgGE/edit?usp=sharing))
4. Оценка — хор или выше (и устраивает): автомат, можно не приходить на зачет
5. Оценка — ниже хора: идете на зачет (максимум +2 балла к оценке)
6. Оценка не устраивает: идете на зачет (максимум +2 балла к оценке)
7. Не пришли на зачет и оценка ниже хора: неявка
8. Запись на зачет будет осуществляться через форму (будет позже)
